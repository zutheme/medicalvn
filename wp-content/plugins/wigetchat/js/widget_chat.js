...
function quick_widget(){ 
   ...
   if( _width_device < 768 ) return false;
            ...
            var interval_zalo_mb = setInterval(function() {
              _bottom = xzalowg.style.bottom;
	            ...
	            let _bottom;
	              ...
	              xzalowg.style.right = "17px";
	              xzalowg.style.left = "auto"; 
	              //xzalowg.style.bottom = "25%";
                xzalowg.style.bottom = "13%";
	              xzalowg.style.zIndex = "900000"; 
	              c--;
	           },100);     
        }
    ...
    var x = document.getElementsByClassName("fb_dialog")[0];
     if (x) {
        ...
        if(_width <= 768 ) {
            ...
            efrm.style.bottom = "3%";
            efrm.style.left = "auto";
            efrm.style.right = "0.7%";
            efrm_chat.style.right = "10px";
            efrm_chat.style.left = "auto";
        } 
