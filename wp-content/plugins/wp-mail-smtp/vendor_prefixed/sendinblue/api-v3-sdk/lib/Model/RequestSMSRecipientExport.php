...
class RequestSMSRecipientExport implements \WPMailSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
    ...
    {
        return [self::RECIPIENTS_TYPE_ALL, self::RECIPIENTS_TYPE_DELIVERED, self::RECIPIENTS_TYPE_ANSWERED, self::RECIPIENTS_TYPE_SOFT_BOUNCES, self::RECIPIENTS_TYPE_HARD_BOUNCES, self::RECIPIENTS_TYPE_UNSUBSCRIBED];
    }
    /**
