 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetStatsByDevice implements \WPMailSMTP\Vendor\SendinBlue\Client\Model\ModelInterface, \ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerFormats = ['desktop' => null, 'mobile' => null, 'tablet' => null, 'unknown' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['desktop' => 'desktop', 'mobile' => 'mobile', 'tablet' => 'tablet', 'unknown' => 'unknown'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['desktop' => 'setDesktop', 'mobile' => 'setMobile', 'tablet' => 'setTablet', 'unknown' => 'setUnknown'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['desktop' => 'getDesktop', 'mobile' => 'getMobile', 'tablet' => 'getTablet', 'unknown' => 'getUnknown'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
