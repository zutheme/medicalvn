...
//video 1
_e_video_container1 = document.getElementsByClassName("doctor-container-video1")[0];
var maxHeightvideo1 = _e_video_container1.offsetHeight;
if(_width < 768){
  maxHeightvideo1 = 360;
}else{
  maxHeightvideo1 = maxHeightvideo1*0.89;
...
if(_width < 768){
  ...
  maxHeightvideo2 = maxHeightvideo2*0.75;
...
//end video 2
//video 4
_e_video_container4 = document.getElementsByClassName("container-video4")[0];
var maxHeightvideo4 = _e_video_container4.offsetHeight;
if(_width < 768){
  maxHeightvideo4 = 360;
}else{
  maxHeightvideo4 = maxHeightvideo4*0.88;
  if(maxHeightvideo4 < 300) {
      maxHeightvideo4 = 325;
  }
}
//video 5
...
if(_width < 768){
  ...
  maxHeightvideo5 = maxHeightvideo5*0.89;
...
function inityoutube(){
      //console.log('maxHeightvideo=',maxHeightvideo);
...
//video 4
      ...
      function  onPlayerStateChanges4(event) {
        ...
        if(event.data == -1 || event.data == 0) {
                    ...
                    var le = player4.getplaylist().length-4;
                    ...
                    if(player4.getplaylist().length != playlist4.length) {
                        ...
                        player4.loadplaylist(playlist4, previousIndex4+4);
...
function func_play(){
  ...
  var _index = findindex(idvideo, playlist);
  player5.playVideoAt(_index);
}
 var previousIndex5 = 0;
      ...
      function  onPlayerStateChanges5(event) {
        ...
        if(event.data == -1 || event.data == 0) {
                    ...
                    var le = player5.getplaylist().length-5;
    ...
    function play_index5(index) {
        //player5.playVideo();
        player5.playVideoAt(index);        
    }
