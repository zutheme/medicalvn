...
class Google_Service_SystemsManagement_PatchJob extends Google_Model
{
  public $createTime;
  public $description;
  public $displayName;
  ...
  public $duration;
  public $errorMessage;
  protected $instanceDetailsSummaryType = 'Google_Service_SystemsManagement_PatchJobInstanceDetailsSummary';
  ...
  /**
   * @param Google_Service_SystemsManagement_PatchJobInstanceDetailsSummary
   */
  public function setInstanceDetailsSummary(Google_Service_SystemsManagement_PatchJobInstanceDetailsSummary $instanceDetailsSummary)
  {
    $this->instanceDetailsSummary = $instanceDetailsSummary;
  }
  /**
   * @return Google_Service_SystemsManagement_PatchJobInstanceDetailsSummary
   */
