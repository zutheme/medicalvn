...
class Google_Service_Fitness_Resource_UsersDataSources extends Google_Service_Resource
{
   ...
   * the contents of the source being created. The dataStreamId field should not
   * be set when invoking this method. It will be automatically generated by the
   ...
   * "com.google.") will create a DataSource with a custom data type. Custom data
   * types are only readable by the application that created them. Custom data
   * types are deprecated; use standard data types instead.
   *
