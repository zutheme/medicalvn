 ...
 *  </code>
 */
class Google_Service_SASPortalTesting_Resource_Customers extends Google_Service_Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_SASPortalTesting_SasPortalCustomer");
  }
  /**
  ...
  public function listCustomers($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_SASPortalTesting_SasPortalListCustomersResponse");
  }
  /**
   ...
   * @return Google_Service_SASPortalTesting_SasPortalCustomer
   */
  public function patch($name, Google_Service_SASPortalTesting_SasPortalCustomer $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_SASPortalTesting_SasPortalCustomer");
  }
}
