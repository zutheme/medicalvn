 ...
 *  </code>
 */
class Google_Service_DisplayVideo_Resource_PartnersChannelsSites extends Google_Service_Resource
{
  /**
   ...
   */
  public function bulkEdit($partnerId, $channelId, Google_Service_DisplayVideo_BulkEditSitesRequest $postBody, $optParams = array())
  {
   ...
   */
  public function create($partnerId, $channelId, Google_Service_DisplayVideo_Site $postBody, $optParams = array())
  {
    $params = array('partnerId' => $partnerId, 'channelId' => $channelId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   */
  public function delete($partnerId, $channelId, $urlOrAppId, $optParams = array())
  {
    $params = array('partnerId' => $partnerId, 'channelId' => $channelId, 'urlOrAppId' => $urlOrAppId);
    $params = array_merge($params, $optParams);
