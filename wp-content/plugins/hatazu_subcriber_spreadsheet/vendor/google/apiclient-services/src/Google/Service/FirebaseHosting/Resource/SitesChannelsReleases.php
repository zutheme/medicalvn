 ...
 *  </code>
 */
class Google_Service_FirebaseHosting_Resource_SitesChannelsReleases extends Google_Service_Resource
{
  /**
   ...
   * (releases.listSitesChannelsReleases)
   *
   ...
   */
  public function listSitesChannelsReleases($parent, $optParams = array())
  {
