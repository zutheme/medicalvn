 ...
 *  </code>
 */
class Google_Service_Logging_Resource_LocationsBuckets extends Google_Service_Resource
{
  /**
  ...
  /**
   * Lists buckets (Beta). (buckets.listLocationsBuckets)
   *
   ...
   */
  public function listLocationsBuckets($parent, $optParams = array())
  {
