 ...
 * Typical usage is:
 *  <code>
 *   $pagespeedonlineService = new Google_Service_PagespeedInsights(...);
 *   $pagespeedapi = $pagespeedonlineService->pagespeedapi;
 *  </code>
 */
class Google_Service_PagespeedInsights_Resource_Pagespeedapi extends Google_Service_Resource
{
  /**
  ...
  public function runpagespeed($optParams = array())
  {
    ...
    return $this->call('runpagespeed', array($params), "Google_Service_PagespeedInsights_PagespeedApiPagespeedResponseV5");
  }
}
