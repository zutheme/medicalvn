...
class Google_Service_CloudMemorystoreforMemcached extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_instances = new Google_Service_CloudMemorystoreforMemcached_Resource_ProjectsLocationsInstances(
        $this,
        $this->serviceName,
        'instances',
        array(
    ...
    $this->projects_locations_operations = new Google_Service_CloudMemorystoreforMemcached_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
