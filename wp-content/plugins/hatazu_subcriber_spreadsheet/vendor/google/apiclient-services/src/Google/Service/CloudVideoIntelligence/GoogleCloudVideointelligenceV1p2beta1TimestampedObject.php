...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p2beta1TimestampedObject extends Google_Collection
{
  protected $collection_key = 'landmarks';
  protected $attributesType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p2beta1DetectedAttribute';
  protected $attributesDataType = 'array';
  protected $landmarksType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p2beta1DetectedLandmark';
  ...
  /**
   * @return Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p2beta1DetectedLandmark
   */
