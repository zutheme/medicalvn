...
class Google_Service_Compute_Resource_RegionTargetHttpsProxies extends Google_Service_Resource
{
   ...
   */
  public function delete($project, $region, $targetHttpsProxy, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpsProxy' => $targetHttpsProxy);
   ...
   */
  public function get($project, $region, $targetHttpsProxy, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpsProxy' => $targetHttpsProxy);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function insert($project, $region, Google_Service_Compute_TargetHttpsProxy $postBody, $optParams = array())
  {
   ...
   */
  public function listRegionTargetHttpsProxies($project, $region, $optParams = array())
  {
   ...
   * @param Google_Service_Compute_RegionTargetHttpsProxiesSetSslCertificatesRequest $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   * Specify a unique request ID so that if you must retry your request, the
   ...
   * @return Google_Service_Compute_Operation
   */
  public function setSslCertificates($project, $region, $targetHttpsProxy, Google_Service_Compute_RegionTargetHttpsProxiesSetSslCertificatesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpsProxy' => $targetHttpsProxy, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function setUrlMap($project, $region, $targetHttpsProxy, Google_Service_Compute_UrlMapReference $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpsProxy' => $targetHttpsProxy, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
