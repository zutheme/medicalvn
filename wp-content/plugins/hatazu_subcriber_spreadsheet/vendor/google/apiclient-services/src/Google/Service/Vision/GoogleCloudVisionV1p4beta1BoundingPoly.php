...
class Google_Service_Vision_GoogleCloudVisionV1p4beta1BoundingPoly extends Google_Collection
{
  protected $collection_key = 'vertices';
  protected $normalizedVerticesType = 'Google_Service_Vision_GoogleCloudVisionV1p4beta1NormalizedVertex';
  protected $normalizedVerticesDataType = 'array';
  protected $verticesType = 'Google_Service_Vision_GoogleCloudVisionV1p4beta1Vertex';
