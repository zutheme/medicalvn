...
class Google_Service_FirebaseManagement_Resource_ProjectsDefaultLocation extends Google_Service_Resource
{
   ...
   *
   * This method creates an App Engine application with a [default Cloud Storage b
   ...
   *
   * The `Operation` can be polled by its `name` using GetOperation until `done`
   * is true. When `done` is true, the `Operation` has either succeeded or failed.
   ...
   * be set to a google.rpc.Status. The `Operation` is automatically deleted after
