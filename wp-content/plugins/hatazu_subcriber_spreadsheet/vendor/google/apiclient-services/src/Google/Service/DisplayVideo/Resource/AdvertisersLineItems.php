...
class Google_Service_DisplayVideo_Resource_AdvertisersLineItems extends Google_Service_Resource
{
   ...
   * be `EQUALS (=)`. * Supported fields:     - `targetingType`     -
   * `inheritance`
   *
   * Examples:
   *
   ...
   * is not specified, line items with `ENTITY_STATUS_ARCHIVED` will not be
   * included in the results. (lineItems.listAdvertisersLineItems)
   *
   ...
   * - `campaignId`     - `insertionOrderId`     - `entityStatus`     -
   * `lineItemType`.
   *
   * Examples:
   *
