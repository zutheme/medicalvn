...
class Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1ExportTaxonomiesResponse extends Google_Collection
{
  protected $collection_key = 'taxonomies';
  protected $taxonomiesType = 'Google_Service_DataCatalog_GoogleCloudDatacatalogV1beta1SerializedTaxonomy';
