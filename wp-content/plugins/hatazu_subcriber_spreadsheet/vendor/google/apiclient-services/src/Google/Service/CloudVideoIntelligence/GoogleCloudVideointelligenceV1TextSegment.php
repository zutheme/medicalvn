...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TextSegment extends Google_Collection
{
  protected $collection_key = 'frames';
  public $confidence;
  protected $framesType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TextFrame';
  ...
  /**
   * @param Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TextFrame
   */
  ...
  /**
   * @return Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TextFrame
   */
