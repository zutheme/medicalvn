 ...
 *  </code>
 */
class Google_Service_DLP_Resource_OrganizationsLocationsDeidentifyTemplates extends Google_Service_Resource
{
  /**
   ...
   */
  public function listOrganizationsLocationsDeidentifyTemplates($parent, $optParams = array())
  {
