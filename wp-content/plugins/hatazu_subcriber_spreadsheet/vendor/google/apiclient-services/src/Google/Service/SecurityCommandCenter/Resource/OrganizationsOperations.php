...
class Google_Service_SecurityCommandCenter_Resource_OrganizationsOperations extends Google_Service_Resource
{
  ...
  public function cancel($name, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "Google_Service_SecurityCommandCenter_SecuritycenterEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_SecurityCommandCenter_Operation");
  }
  /**
  ...
  public function listOrganizationsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_SecurityCommandCenter_ListOperationsResponse");
  }
}
