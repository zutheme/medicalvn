 ...
 *  </code>
 */
class Google_Service_Vision_Resource_ProjectsLocationsFiles extends Google_Service_Resource
{
  /**
   ...
   */
  public function annotate($parent, Google_Service_Vision_BatchAnnotateFilesRequest $postBody, $optParams = array())
  {
   ...
   */
  public function asyncBatchAnnotate($parent, Google_Service_Vision_AsyncBatchAnnotateFilesRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
