...
class Google_Service_Compute_Resource_RegionSslCertificates extends Google_Service_Resource
{
   ...
   */
  public function delete($project, $region, $sslCertificate, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'sslCertificate' => $sslCertificate);
   ...
   */
  public function get($project, $region, $sslCertificate, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'sslCertificate' => $sslCertificate);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function insert($project, $region, Google_Service_Compute_SslCertificate $postBody, $optParams = array())
  {
   ...
   */
  public function listRegionSslCertificates($project, $region, $optParams = array())
  {
