...
class Google_Service_Compute_Resource_RegionHealthChecks extends Google_Service_Resource
{
   ...
   */
  public function delete($project, $region, $healthCheck, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'healthCheck' => $healthCheck);
   ...
   */
  public function get($project, $region, $healthCheck, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'healthCheck' => $healthCheck);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function insert($project, $region, Google_Service_Compute_HealthCheck $postBody, $optParams = array())
  {
   ...
   */
  public function listRegionHealthChecks($project, $region, $optParams = array())
  {
   ...
   * @return Google_Service_Compute_Operation
   */
  public function patch($project, $region, $healthCheck, Google_Service_Compute_HealthCheck $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'healthCheck' => $healthCheck, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function update($project, $region, $healthCheck, Google_Service_Compute_HealthCheck $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'healthCheck' => $healthCheck, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
