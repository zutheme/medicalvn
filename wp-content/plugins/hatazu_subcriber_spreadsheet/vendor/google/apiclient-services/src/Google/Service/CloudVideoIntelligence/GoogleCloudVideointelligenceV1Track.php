...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1Track extends Google_Collection
{
  ...
  protected $timestampedObjectsType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TimestampedObject';
  ...
  /**
   * @return Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1TimestampedObject
   */
