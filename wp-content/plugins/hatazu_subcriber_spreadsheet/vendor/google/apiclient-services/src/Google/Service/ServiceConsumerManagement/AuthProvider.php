...
class Google_Service_ServiceConsumerManagement_AuthProvider extends Google_Collection
{
  ...
  public $issuer;
  public $jwksUri;
  protected $jwtLocationsType = 'Google_Service_ServiceConsumerManagement_JwtLocation';
