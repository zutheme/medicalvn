 ...
 * @author Google, Inc.
 */
class Google_Service_ServiceDirectory extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_namespaces = new Google_Service_ServiceDirectory_Resource_ProjectsLocationsNamespaces(
        $this,
        $this->serviceName,
        'namespaces',
        array(
    ...
    $this->projects_locations_namespaces_services = new Google_Service_ServiceDirectory_Resource_ProjectsLocationsNamespacesServices(
        $this,
        $this->serviceName,
        'services',
        array(
    ...
    $this->projects_locations_namespaces_services_endpoints = new Google_Service_ServiceDirectory_Resource_ProjectsLocationsNamespacesServicesEndpoints(
        $this,
        $this->serviceName,
        'endpoints',
        array(
