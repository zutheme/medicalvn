...
class Google_Service_SASPortalTesting extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->customers = new Google_Service_SASPortalTesting_Resource_Customers(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->customers_nodes = new Google_Service_SASPortalTesting_Resource_CustomersNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->customers_nodes_nodes = new Google_Service_SASPortalTesting_Resource_CustomersNodesNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->installer = new Google_Service_SASPortalTesting_Resource_Installer(
        $this,
        $this->serviceName,
        'installer',
        array(
    ...
    $this->nodes = new Google_Service_SASPortalTesting_Resource_Nodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->nodes_nodes = new Google_Service_SASPortalTesting_Resource_NodesNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->nodes_nodes_nodes = new Google_Service_SASPortalTesting_Resource_NodesNodesNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->policies = new Google_Service_SASPortalTesting_Resource_Policies(
        $this,
        $this->serviceName,
        'policies',
        array(
