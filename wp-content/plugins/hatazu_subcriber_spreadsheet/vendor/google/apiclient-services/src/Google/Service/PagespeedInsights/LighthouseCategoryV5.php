...
class Google_Service_PagespeedInsights_LighthouseCategoryV5 extends Google_Collection
{
  protected $collection_key = 'auditRefs';
  protected $auditRefsType = 'Google_Service_PagespeedInsights_AuditRefs';
