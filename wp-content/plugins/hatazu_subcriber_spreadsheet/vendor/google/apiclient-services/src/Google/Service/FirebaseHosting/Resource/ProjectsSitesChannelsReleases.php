 ...
 *  </code>
 */
class Google_Service_FirebaseHosting_Resource_ProjectsSitesChannelsReleases extends Google_Service_Resource
{
  /**
   ...
   * (releases.listProjectsSitesChannelsReleases)
   *
   ...
   */
  public function listProjectsSitesChannelsReleases($parent, $optParams = array())
  {
