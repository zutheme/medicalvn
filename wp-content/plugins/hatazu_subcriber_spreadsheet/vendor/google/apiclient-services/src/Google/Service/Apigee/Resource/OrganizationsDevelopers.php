...
class Google_Service_Apigee_Resource_OrganizationsDevelopers extends Google_Service_Resource
{
   ...
   * request. Add new attributes, and include or exclude any existing attributes
   * that you want to retain or remove, respectively.
   *
   ...
   * status, use the SetDeveloperStatus API. (developers.create)
   *
   ...
   * artifacts.
   *
   * To avoid permanently deleting developers and their artifacts, set the
   ...
   * query parameters. (developers.listOrganizationsDevelopers)
   *
   ...
   * generated during app creation won't work.
   *
   * If successful, the API call returns the following HTTP status code: `204 No
   * Content` (developers.setDeveloperStatus)
   *
   * @param string $name Required. Email address of the developer. Use the
   * following structure in your request:
   * `organizations/{org}/developers/{developer_email}`
   ...
   * Updates a developer.
   *
   * This API replaces the existing developer details with those specified in the
   * request. Include or exclude any existing details that you want to retain or
   * delete, respectively.
   *
   * The custom attribute limit is 18.
   *
