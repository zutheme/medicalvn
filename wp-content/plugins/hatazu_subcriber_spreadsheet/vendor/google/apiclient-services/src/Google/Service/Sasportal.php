 ...
 * @author Google, Inc.
 */
class Google_Service_Sasportal extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->customers = new Google_Service_Sasportal_Resource_Customers(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->customers_devices = new Google_Service_Sasportal_Resource_CustomersDevices(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->customers_nodes = new Google_Service_Sasportal_Resource_CustomersNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->nodes_nodes = new Google_Service_Sasportal_Resource_NodesNodes(
        $this,
        $this->serviceName,
        'nodes',
        array(
    ...
    $this->policies = new Google_Service_Sasportal_Resource_Policies(
        $this,
        $this->serviceName,
        'policies',
        array(
