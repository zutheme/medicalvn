...
class Google_Service_GameServices_Policy extends Google_Collection
{
  protected $collection_key = 'rules';
  protected $auditConfigsType = 'Google_Service_GameServices_AuditConfig';
  protected $auditConfigsDataType = 'array';
  protected $bindingsType = 'Google_Service_GameServices_Binding';
  protected $bindingsDataType = 'array';
  public $etag;
  public $iamOwned;
  protected $rulesType = 'Google_Service_GameServices_Rule';
