...
class Google_Service_CloudSearch_GetCustomerSessionStatsResponse extends Google_Collection
{
  protected $collection_key = 'stats';
  protected $statsType = 'Google_Service_CloudSearch_CustomerSessionStats';
