...
class Google_Service_Compute_Resource_RegionTargetHttpProxies extends Google_Service_Resource
{
   ...
   */
  public function delete($project, $region, $targetHttpProxy, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpProxy' => $targetHttpProxy);
   ...
   */
  public function get($project, $region, $targetHttpProxy, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpProxy' => $targetHttpProxy);
    $params = array_merge($params, $optParams);
   ...
   * @return Google_Service_Compute_Operation
   */
  public function insert($project, $region, Google_Service_Compute_TargetHttpProxy $postBody, $optParams = array())
  {
   ...
   */
  public function listRegionTargetHttpProxies($project, $region, $optParams = array())
  {
   ...
   * @return Google_Service_Compute_Operation
   */
  public function setUrlMap($project, $region, $targetHttpProxy, Google_Service_Compute_UrlMapReference $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'targetHttpProxy' => $targetHttpProxy, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
