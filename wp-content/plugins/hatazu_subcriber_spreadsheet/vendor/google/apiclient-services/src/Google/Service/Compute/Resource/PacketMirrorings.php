 ...
 *  </code>
 */
class Google_Service_Compute_Resource_PacketMirrorings extends Google_Service_Resource
{
  /**
   ...
   * of results.
   * @return Google_Service_Compute_PacketMirroringAggregatedList
   */
  public function aggregatedList($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('aggregatedList', array($params), "Google_Service_Compute_PacketMirroringAggregatedList");
  }
  /**
   ...
   */
  public function delete($project, $region, $packetMirroring, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'packetMirroring' => $packetMirroring);
    $params = array_merge($params, $optParams);
   ...
   */
  public function get($project, $region, $packetMirroring, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'packetMirroring' => $packetMirroring);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Compute_PacketMirroring");
  }
  /**
   ...
   * @param string $project Project ID for this request.
   * @param string $region Name of the region for this request.
   * @param Google_Service_Compute_PacketMirroring $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string requestId An optional request ID to identify requests.
   * Specify a unique request ID so that if you must retry your request, the
   ...
   * @return Google_Service_Compute_Operation
   */
  public function insert($project, $region, Google_Service_Compute_PacketMirroring $postBody, $optParams = array())
  {
   ...
   * the `nextPageToken` returned by a previous list request to get the next page
   * of results.
   * @return Google_Service_Compute_PacketMirroringList
   */
  public function listPacketMirrorings($project, $region, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Compute_PacketMirroringList");
  }
  /**
   ...
   * @return Google_Service_Compute_Operation
   */
  public function patch($project, $region, $packetMirroring, Google_Service_Compute_PacketMirroring $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'region' => $region, 'packetMirroring' => $packetMirroring, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
