 ...
 * @author Google, Inc.
 */
class Google_Service_NetworkManagement extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_global_connectivityTests = new Google_Service_NetworkManagement_Resource_ProjectsLocationsNetworkmanagementGlobalConnectivityTests(
        $this,
        $this->serviceName,
        'connectivityTests',
        array(
    ...
    $this->projects_locations_global_operations = new Google_Service_NetworkManagement_Resource_ProjectsLocationsNetworkmanagementGlobalOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
