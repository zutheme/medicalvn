...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p3beta1AnnotateVideoProgress extends Google_Collection
{
  protected $collection_key = 'annotationProgress';
  protected $annotationProgressType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress';
