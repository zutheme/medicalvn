...
class Google_Service_FirebaseManagement_SearchFirebaseAppsResponse extends Google_Collection
{
  protected $collection_key = 'apps';
  protected $appsType = 'Google_Service_FirebaseManagement_FirebaseAppInfo';
