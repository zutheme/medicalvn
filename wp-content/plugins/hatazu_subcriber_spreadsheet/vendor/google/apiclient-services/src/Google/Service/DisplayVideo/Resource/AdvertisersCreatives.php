...
class Google_Service_DisplayVideo_Resource_AdvertisersCreatives extends Google_Service_Resource
{
   ...
   * is not specified, creatives with `ENTITY_STATUS_ARCHIVED` will not be
   * included in the results. (creatives.listAdvertisersCreatives)
   *
   ...
   * @opt_param string filter Allows filtering by creative properties.
   *
   * Supported syntax:
   *
   ...
   * Examples:
   *
   * * All native creatives: `creativeType="CREATIVE_TYPE_NATIVE"` * All active
   ...
   * (sorts by width first, then by height)
   *
