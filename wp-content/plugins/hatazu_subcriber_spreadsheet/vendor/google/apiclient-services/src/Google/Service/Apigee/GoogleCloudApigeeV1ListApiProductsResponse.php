...
class Google_Service_Apigee_GoogleCloudApigeeV1ListApiProductsResponse extends Google_Collection
{
  protected $collection_key = 'apiProduct';
  protected $apiProductType = 'Google_Service_Apigee_GoogleCloudApigeeV1ApiProduct';
