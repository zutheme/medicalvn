...
class Google_Service_SASPortalTesting_SasPortalPolicy extends Google_Collection
{
  protected $collection_key = 'assignments';
  protected $assignmentsType = 'Google_Service_SASPortalTesting_SasPortalAssignment';
