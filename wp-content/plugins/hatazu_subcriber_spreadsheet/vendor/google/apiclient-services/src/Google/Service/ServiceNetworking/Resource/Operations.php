...
class Google_Service_ServiceNetworking_Resource_Operations extends Google_Service_Resource
{
   ...
   * @param Google_Service_ServiceNetworking_CancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_ServiceNetworking_ServicenetworkingEmpty
   */
  public function cancel($name, Google_Service_ServiceNetworking_CancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_ServiceNetworking_ServicenetworkingEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_ServiceNetworking_ServicenetworkingEmpty");
  }
  /**
  ...
  public function listOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_ServiceNetworking_ListOperationsResponse");
  }
}
