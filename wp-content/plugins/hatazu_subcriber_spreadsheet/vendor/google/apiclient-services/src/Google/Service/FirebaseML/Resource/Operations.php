 ...
 *   $operations = $firebasemlService->operations;
 *  </code>
 */
class Google_Service_FirebaseML_Resource_Operations extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_FirebaseML_CancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_FirebaseML_FirebasemlEmpty
   */
  public function cancel($name, Google_Service_FirebaseML_CancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_FirebaseML_FirebasemlEmpty");
  }
  /**
   ...
   * @return Google_Service_FirebaseML_ListOperationsResponse
   */
  public function listOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_FirebaseML_ListOperationsResponse");
  }
}
