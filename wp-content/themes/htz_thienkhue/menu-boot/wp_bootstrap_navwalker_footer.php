...
class wp_bootstrap_navwalker_footer extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			if($args->has_children && $depth === 0) { $class_names .= ' has-sub'; } elseif($args->has_children && $depth > 0) { $class_names .= ' has-sub'; }
			...
			if ( ! empty( $item->attr_title ) )
				$item_output .= '<a'. $attributes .'><i class="fa fa-caret-right" aria-hidden="true"></i>';
			else
				$item_output .= '<a'. $attributes .'><i class="fa fa-caret-right" aria-hidden="true"></i>';
