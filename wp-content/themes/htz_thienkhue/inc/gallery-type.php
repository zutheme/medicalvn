...
function prfx_field_custom_gallery_meta() {

    add_meta_box( 'prfx_meta', __( 'Field Box Title', 'prfx-textdomain' ), 'prfx_field_meta_gallery_callback', 'gallerys','normal', 'high');

}

add_action( 'add_meta_boxes', 'prfx_field_custom_gallery_meta');
...
function prfx_field_meta_gallery_callback( $post ) {
    ...
    <p>
        ...
        <input type="text" name="opt-gallery-field" id="link" value="<?php if ( isset ( $prfx_stored_meta['opt-gallery-field'] ) ) echo $prfx_stored_meta['opt-gallery-field'][0]; ?>" />
    </p>
...
function prfx_field_gallery_save( $post_id ) {
    ...
    if ( "gallerys" != $post_type ) return;   

    if( isset( $_POST['opt-gallery-field'] ) ) {

        update_post_meta( $post_id, 'opt-gallery-field', $_POST[ 'opt-gallery-field' ] );    
...
add_action( 'save_post', 'prfx_field_gallery_save' );
