...
function htz_thienkhue_scripts() {
	...
	//}
	if ( is_front_page() ) {
		wp_enqueue_style('style_2.css', get_template_directory_uri() . '/css/style_2.css',array(), '0.4.2.4', false);
		//wp_enqueue_script( 'slide_menu_home.', get_template_directory_uri() . '/js/slide_menu_home.js', array(), '0.0.3.3', true );
	}
	 if ( !is_front_page() ) {
		wp_enqueue_style( 'style-single', get_template_directory_uri() . '/css/style.css',array(), '0.1.9.6', false);
