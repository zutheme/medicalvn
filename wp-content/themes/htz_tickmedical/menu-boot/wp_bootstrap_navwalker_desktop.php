...
class wp_bootstrap_navwalker_desktop extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if($args->has_children && $depth === 0){
			$output .= "\n$indent<ul role=\"menu\" class=\" wsmenu-list dropdown-menu\">\n";
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			*/
			...
			if($args->has_children && 0 === $depth) {
				...
				$item_output .= ' <span class="wsarrow"></span></a>';
			}else{
				$item_output .= '</a>';
			}
