<?php 
$slug_meta = get_the_author_meta( 'slug_meta', $loop_slug );
echo $slug_meta;
...
if ($team_query->have_posts()) {
  while ($team_query->have_posts()) {
    ...
    ?>
    <div class="col-xs-12 col-sm-4 col-md-3 portfolio-wrapper III_column" data-groups='["all", "<?php echo $lst_slug[0]; ?>"]'>
